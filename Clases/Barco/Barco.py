...
# getters y setters es_Especial
    ...
    def set_combustible_max(self, Max):
...
# -----------Funciones-----------
    ...
    def viajar(self):
        ...
        try:
            ...
            ).gastar_combustible(self.__viaje.get_horas())
            self.combustible_suficiente(combustible_Gastado)
            self.set_combustible_Actual(self.get_combustible_Actual(
